...
Basic_Q = ("what is diabetes", "diabetes", "diabetes information", "high blood sugar","i have diabetes","can you help me understand diabetes")
Basic_Ans = "Diabetes mellitus, commonly known as diabetes, is a metabolic disease that causes high blood sugar. The hormone insulin moves sugar from the blood into your cells to be stored or used for energy. With diabetes, your body either doesn't make enough insulin or can't effectively use the insulin it does make.can i help you to recommend a good doctor nearby."
Basic_Om = ("diabetes medicines", "diabetes med")
Basic_AnsM = ["glimepiride,glimepiride-pioglitazone",
